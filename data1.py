...
def use_dom(path):
    ...
    # change tag and save todo
    print("*************** TESTR *******************")
    for person in people:
        firstname = person.getElementsByTagName('firstname')[0]
        firstname.childNodes[0].tag = "secondName"

    with open('exampleChangedDOM.xml', 'w') as f:
        DOMTree.documentElement.getElementsByTagName("person")
